...
config :senpai_web, SenpaiWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "FVqvuUnHB5Pl6LX8Jmr+7xvZCY9QTLEyFHIsDTfbNJmdlbovdGjkZWd9ydRa9FXD",
  watchers: [
...
config :senpai_web, SenpaiWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"lib/senpai_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :senpai_web, dev_routes: true
